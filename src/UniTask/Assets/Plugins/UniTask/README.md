...
- [Installation](#installation)
  - [Unity Package Manager (via Git URL)](#unity-package-manager-via-git-url)
...
Getting started
---
Install via [Installation](#installation) from `https://upm.thanhdv.com/`, or use the git URL from [Fork.Lib.UniTask/releases](https://github.com/ThanhDV143/Fork.Lib.UniTask/releases).
...
API References
---
API references can be generated from the DocFX configuration in this repository.
...
```
https://github.com/ThanhDV143/Fork.Lib.UniTask.git?path=src/UniTask/Assets/Plugins/UniTask
```
...
- Press the **+** button, choose "**Add package by name...**" → `thanhdv.fork.cysharp.unitask`
- or
